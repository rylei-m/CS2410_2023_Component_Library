...
document.getElementById("carousel-html").innerText = `
    <div class="carousel">
        <div class="carousel-slide" style="background-image: url('yourimagehere.png');"></div>
        <div class="carousel-slide" style="background-image: url('yourimagehere.png');"></div>
        <div class="carousel-slide" style="background-image: url('yourimagehere.png');"></div>
...
`;
document.getElementById("carousel2-html").innerText = `
<div class="carousel-container">
    <div class="carousel">
        <img src="yourimagehere.png" alt="Your Description">
        <img src="your_imagehere.png" alt="Your Description">
        <img src="yourimage_here.png" alt="Your Description">
        <img src="yourimagehere.png" alt="Your Description">
        <img src="your_imagehere.png" alt="Your Description">
    </div>
</div>
<nav class="CarouselLabels">
    <div class="links">
        <p><h3>HTML</h3></p>
        <p><pre id="carousel-html"></pre></p>
        <p><h3>CSS</h3></p>
        <p><pre id="carousel-css"></pre></p>
    </div>
</nav>
`;
document.getElementById("carousel2-css").innerText = `
.carousel-container {
    overflow: hidden;
    width: flex; /* Adjust to match the image width */
    height: 500px; /* Adjust to match the image height */
}

.carousel {
    display: flex;
    animation: slide 50s infinite linear; /* Adjust time as needed */
}

.carousel img {
    width: flex; 
    height: 500px; /* Match the individual image height */
    object-fit: cover;
}

@keyframes slide {
    0% { transform: translateX(0); }
    20% { transform: translateX(-400px); } /* Slide width */
    40% { transform: translateX(-800px); }
    60% { transform: translateX(-1200px); }
    80% { transform: translateX(-1600px); }
    100% { transform: translateX(-2000px); } /* 5 images x 400px */
}
`;